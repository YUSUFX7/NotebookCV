...
def preprocess(frame,drawState,fps):
    ...
    if color=='black':
        cv2.putText(frame,f'Eraser',(int(1.22*settings['window_width']//7),settings['window_height']-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,255,255),2)
    ...
    cv2.putText(frame,f'Clear (C)',(int(2.3*settings['window_width']//6),settings['window_height']-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,255,255),2)
    ...
    cv2.putText(frame,f'Save (S)',(int(3.25*settings['window_width']//6),settings['window_height']-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,255,255),2)
    ...
    cv2.putText(frame,f'Quit (Q)',(int(3.48*settings['window_width']//5),settings['window_height']-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,255,255),2)
    ...
    cv2.putText(frame,f'{int(fps)} FPS',(int(3.45*settings['window_width']//4),settings['window_height']-20),cv2.FONT_HERSHEY_TRIPLEX,1,(255,255,255),2)

    if drawState == 'Draw':
        draw_label = 'Write'
        draw_label_color = (0, 255, 0)  # Green
    else:
        draw_label = 'Hold'
        draw_label_color = (0, 0, 255)  # Red
    cv2.putText(frame, f'{draw_label}', (20, settings['window_height'] - 20), cv2.FONT_HERSHEY_TRIPLEX, 1, draw_label_color, 2)
    return frame
